...
Welcome to `biocborn` contributor's guide.
...
If you experience bugs or general issues with `biocborn`, please have a look
...
You can help improve `biocborn` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`biocborn` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `biocborn`'s files. While this mechanism can
...
```
conda create -n biocborn python=3 six virtualenv pytest pytest-cov
conda activate biocborn
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/biocborn.git
   cd biocborn
   ```
...
5. Install [pre-commit]:
   ...
   `biocborn` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/biocborn
[issue tracker]: https://github.com/<USERNAME>/biocborn/issues
